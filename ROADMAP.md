# ROADMAP
- [ ] 0.7 Implement a next modest, feasible and reasonable MIGRATION_ROADMAP.md step (#51)

- [ ] 0.6 Add an on the fly rendered SYSTEM_OVERVIEW.plantuml to the README.md and insure it is shown in rtd too (#49)
