...
class WebFocusReportListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by WebFocusReportParser#merge_assignment.
    def enterMerge_assignment(self, ctx:WebFocusReportParser.Merge_assignmentContext):
        pass

    # Exit a parse tree produced by WebFocusReportParser#merge_assignment.
    def exitMerge_assignment(self, ctx:WebFocusReportParser.Merge_assignmentContext):
        pass
