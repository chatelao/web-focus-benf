...
class TestEmitter(unittest.TestCase):
    ...
    def test_emit_instruction_report(self):
        ...
        self.assertIn("SELECT \"MYTABLE\".\"FIELD1\", \"MYTABLE\".\"FIELD2\"", sql)
    ...
    def test_emit_instruction_report_with_where(self):
        ...
        self.assertIn("WHERE (\"MYTABLE\".\"FIELD1\" > 10)", sql)
        self.assertIn("AND (\"MYTABLE\".\"FIELD2\" BETWEEN 1 AND 100)", sql)
        self.assertIn("AND (\"MYTABLE\".\"FIELD3\" IN ('A', 'B'))", sql)
        self.assertIn("AND (\"MYTABLE\".\"FIELD4\" IS NULL)", sql)
    ...
    def test_emit_instruction_report_advanced(self):
        ...
        self.assertIn("SELECT \"SALES_DATA\".\"REGION\", \"SALES_DATA\".\"DATE\", SUM(\"SALES_DATA\".\"SALES\") AS \"Total Sales\", AVG(\"SALES_DATA\".\"COST\")", sql)
        self.assertIn("FROM \"SALES_DATA\"", sql)
        # GROUP BY should include all sort fields
        self.assertIn("GROUP BY \"SALES_DATA\".\"REGION\", \"SALES_DATA\".\"DATE\", \"SALES_DATA\".\"DEPT\"", sql)
        # ORDER BY
        self.assertIn("ORDER BY \"SALES_DATA\".\"REGION\" ASC, \"SALES_DATA\".\"DATE\" DESC, \"SALES_DATA\".\"DEPT\" ASC", sql)
    ...
    def test_emit_instruction_report_with_where_total(self):
        ...
        self.assertIn("SELECT \"SALES_DATA\".\"REGION\", SUM(\"SALES_DATA\".\"SALES\")", sql)
        self.assertIn("GROUP BY \"SALES_DATA\".\"REGION\"", sql)
        self.assertIn("HAVING (SUM(\"SALES_DATA\".\"SALES\") > 1000)", sql)
    ...
    def test_emit_instruction_report_with_compute(self):
        ...
        self.assertIn("SELECT SUM(\"SALES_DATA\".\"SALES\"), (SUM(\"SALES_DATA\".\"SALES\") / 1000) AS \"RATIO\"", sql)
    ...
    def test_emit_instruction_define_and_lift(self):
        ...
        self.assertIn("SELECT SUM(\"SALES_DATA\".\"SALES\"), SUM((\"SALES_DATA\".\"SALES\" * 0.1)) AS \"BONUS\"", sql)
    ...
    def test_emit_instruction_define_recursive_lifting(self):
        ...
        self.assertIn("SELECT (\"SALES_DATA\".\"SALARY\" + (\"SALES_DATA\".\"SALES\" * 0.1)) AS \"TOTAL_COMP\"", sql)
