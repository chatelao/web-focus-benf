...
class TestLegacyVerbParity(unittest.TestCase):
    ...
    def test_print_parity(self, mock_connect, mock_runner_conn):
        ...
        self.assertIn("\"INVENTORY\".\"PROD_ID\"", self.last_sql)
        self.assertIn("\"INVENTORY\".\"QTY\"", self.last_sql)
        self.assertIn("\"INVENTORY\".\"PRICE\"", self.last_sql)
    ...
    def test_sum_parity(self, mock_connect, mock_runner_conn):
        ...
        # Verify SQL semantics
        self.assertIn("SUM(\"INVENTORY\".\"QTY\")", self.last_sql)
        self.assertIn("GROUP BY", self.last_sql)
        self.assertIn("\"INVENTORY\".\"CATEGORY\"", self.last_sql)
    ...
    def test_count_parity(self, mock_connect, mock_runner_conn):
        ...
        # Verify SQL semantics
        self.assertIn("COUNT(\"INVENTORY\".\"PROD_ID\")", self.last_sql)
        self.assertIn("GROUP BY", self.last_sql)
    ...
    def test_list_parity(self, mock_connect, mock_runner_conn):
        ...
        self.assertIn("OVER (PARTITION BY \"INVENTORY\".\"CATEGORY\"", self.last_sql)
